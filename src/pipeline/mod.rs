...
pub async fn run_pipeline(
    ...
    info!("[1/4] Generating structured Storyboard Outline...");
    ...
    info!("[3/4] Assembling script.rpy...");
...
"#,
    ...
    info!("[4/4] Verifying generated project with Ren'Py lint...");

    for attempt in 1..=max_fix_attempts {
        let lint_output = run_renpy_lint(&sdk_path, &output_game_dir)?;
        if lint_output.status.success() {
            info!("[4/4] Lint passed on attempt {}.", attempt);
            break;
        }
